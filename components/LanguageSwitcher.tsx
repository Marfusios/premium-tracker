...
import { UKFlag, CzechFlag, GermanFlag, SpainFlag, FrenchFlag, PolishFlag, CroatianFlag, UkrainianFlag } from './flags';
    ...
    return (
        <div className={containerClasses}>
            <div className="relative flex items-center bg-brand-surface rounded-lg shadow-md">
                ...
                <select
                    value={language}
                    onChange={(e) => setLanguage(e.target.value as 'en' | 'cs' | 'es' | 'de' | 'fr' | 'pl' | 'hr' | 'uk')}
